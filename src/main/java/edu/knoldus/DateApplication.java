...
public class DateApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getDaysOfBirthday("1994-11-21"));
        System.out.println(getTimeZoneValue("Africa/Algiers"));
        System.out.println(mahtmaGandhiLivedInSeconds());
        System.out.println(findingLeapYear());
    }

    /**
     * Returning The list of days of my birthdate to till current year.
